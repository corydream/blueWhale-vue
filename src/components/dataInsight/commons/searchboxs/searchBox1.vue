      ...
      <div class="searchBox row" :class="{flod:showFloder}">
        <div class="searchWrap">
          <div class="search-top">
            ...
            <div class="seaTop-midlle bsrCategory">
              <span class="seller">&nbsp;&nbsp;&nbsp;大类目:</span>
              <Select
                v-model="TableItem.tableContainer.queryData.BSRsort.inputVal"
                filterable
                class="inputBox"
                style="width:288px"
                placeholder="全部"
                @on-change="changeBsrCategory">
            ...
            <div v-show="showFloder" class="seaTop-midlle">
              <span>BSR排名:</span>
              <Select v-model="TableItem.tableContainer.queryData.BSR.selectValue" style="width:81px"
                      @on-change="chooseSection(TableItem.tableContainer.queryData.BSR)">
            ...
            <div v-show="showFloder" class="seaTop-left productName mySearchProduct">
              ...
              <!--<Input v-model="TableItem.tableContainer.queryData.product.inputVal" placeholder="请输入产品名称"-->
                     <!--class="inputBox" style="width: 288px"></Input>-->
          ...
          <div class="btnsBox" :class="{flod:showFloder}">
            ...
            <Button type="primary"  @click="searchBefore(false)" style="margin-right: 25px">搜索</Button>
  ...
  import searchBoxUtil from  "../../../../config/insight/commons/searchBoxClass";
    export default {
      ...
      methods:{
        ...
        /*----------表格搜索--------------*/
        //搜索判断
        searchBefore(currentType){
          console.log(this.$store.state.selectTab);
          let tabName=this.$store.state.selectTab;
          switch (tabName){
            case "tab2":
              this.searchDataTab2(currentType);
              break;
            case "tab1":
            case "tab3":
              this.searchData(currentType)
              break;
          }
        },
        //tab2表格搜索
        searchDataTab2(currentType){
          //发送请求
          this.$set(this.TableItem.initCondition,"condition",searchBoxUtil.searchForTabTwo(
            this.TableItem.tableContainer.queryData,this.TableItem.initCondition.measures));
        ...
        searchData(currentType){
          //发送请求
          this.$set(this.TableItem.initCondition,"condition",searchBoxUtil.searchForTabOthers(this.TableItem.tableContainer.queryData));
          this.$set(this.TableItem.initCondition, "type", "part");
          this.$set(this.TableItem.initCondition, "isCategory",currentType?currentType:false);
          this.$parent.$refs.tableList.$refs.tableWrapper.mockTableData();
        },
