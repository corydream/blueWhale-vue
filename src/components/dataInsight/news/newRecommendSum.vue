    ...
    <div>
      ...
      <div class="fixFather">
        <TableList :TableItem="TableItem"
                   ...
                   ref="table">
          <div class="FlodBox" slot="chartBox">
            <div class="showBoxWrap">
              ...
              <div class="isShowWrap" v-show="boxshowFloder">
                <div class="wrap row">
                  <IndicatorItem :indicatorItem="indicatorItem" :showMessage="showMessage"
                                 @changeShow="changeShow"
                                 :chooseType="chooseType" v-if="modelShow.indicatorDisplay" ref="indicator"></IndicatorItem>
                </div>
                <EchartItem :echartItem="echartItem" :showMessage="showMessage" :chooseType="chooseType"
                            v-if="modelShow.echartDisplay" ref="charts"
                            @changeShow="changeShow"
                ></EchartItem>
              </div>
            </div>
...
<script>
  ...
  //页面初始数据
  import initDatas from "../../../config/insight/recommendDatas/amazon/recommendData2";
  //通用方法
  ...
  export default {
    data() {
      return {
        echartItem:{
          //图表
          echartContainer:initDatas.echartContainer,
          permeateTips:"上级类目渗透率分析:查看当前类目在其上级类目HNR -top100中出现次数分布情况。如选择最高级类目，则无法显示该图表。",
          chartClass:'myRecommend',
          chartWrapClass:'myRecommendchart',
          //请求配置
          parmasConfig:initDatas.parmasConfig,
          initCondition:initDatas.initCondition,
          type:"news",
          keywordType:"newsKeyword",
          showFloderData:[]
        },
        TableItem:{
          //表格
        ...
        categoryItem:{
          ...
          parmasConfig:initDatas.parmasConfig,
          initCondition:initDatas.initCondition,
          categoryTitle:"Hot New Release Top100数据",
          type:"news",
          showNewColumn:"name1",
    ...
    components:{
      EchartItem,TableList,CategoryItem,IndicatorItem
    },
    props:['category'],
    created(){
  ...
  /*  beforeRouteLeave(to, from , next){
    ...
    /*  this.$nextTick(() => {
        ...
        window.onresize = () => {
          //重置容器高宽
          if (this.$route.path == "/dataObserve/0/news/newRecommend/newRecommendSum") {
    ...
    methods: {
      ...
      isShowGraph(){
        ...
        if(this.boxshowFloder){
          //全部展开
          if(!sessionStorage.getItem("showNewChart")){
            //指标展开
            ...
            //根据sessionStorage来显示
            let currentShow=JSON.parse(sessionStorage.getItem("showNewChart"));
            //指标展开
        ...
        sessionStorage.setItem("showNewChart",JSON.stringify({
      ...
      setechartCondition() {
        ...
        this.echartItem.echartContainer.echartInfo.permeatedata.measures = commonUtil.setConditions("measures", [
          ...
          {
            "chinese": "排序",
            "col": "RPT_KYLIN_AMAZON_LIPS_RATE.ORDERBY",
            "uuid": "fde1a1e2-0205-4a25-9e01-060c6ea4d3434",
            "sortType": "ASC"
          }
        ])
