let list2 ={
  ...
  databoardTarget: {
    avgPrice: {
      ...
      tips:"爆品平均价格:对应best sellers(热卖榜)细分类目下，所有爆品的平均价格，根据最新爬取的数据进行数值更新。",
      position:"top-start"
    },
    avgReview: {
      title: "爆品平均review数",
      ...
      tips:"爆品平均review数:对应best sellers(热卖榜)细分类目下，所有爆品的平均review数，根据最新爬取的数据进行数值更新。",
      position:"top-start"
    },
    avgRate: {
      title: "爆品平均评分数",
      ...
      tips:"爆品平均评分数:对应best sellers(热卖榜)细分类目下，所有爆品的平均评分数，根据最新爬取的数据进行数值更新。",
      position:"top-start"
    },
    avgBSR: {
      title: "爆品平均上架天数",
      ...
      tips:"爆品平均上架天数:对应best sellers(热卖榜)细分类目下，所有爆品平均上架天数，根据最新爬取的数据进行数值更新。",
      position:"top-end"
    }
  },
  //图表数据
  ...
  tableDatas:{
    ...
    queryData: {
      ...
      incrementTop:{
        ...
        col: "$repl$top",
        columnType: "NUMBER",
        uuid: "8d1hhh9aa9c-19ad-44s8-b859-f6d904aef88a",
        relation: "EQUAL"
      },
      deflection:{
        inputVal:[0,100],
      ...
      sellDays:{
        ...
        col: "$repl$counts",
        columnType: "NUMBER",
        uuid: "8d19aa9c-19ad-44s8-b859-f6d904aef88a",
        relation: "EQUAL",
      },
      //asin
      asin: {
