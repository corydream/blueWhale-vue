...
const axiosBaseConfig = {
  ...
  transformResponse: [respData =>{
    ...
    if (typeof respData.status !== 'undefined') {
      ...
      throw new Error(respData.errMsg||respData.desc)
    }
  }],
}
// axios 实例
...
const fetchJSONByGet = (url, target) => (reqData, handleCancel) => axiosGet(url, reqData, target, handleCancel)
export {
  fetchJSONByPost,  
  fetchJSONByGet,
  axiosBaseConfig,
